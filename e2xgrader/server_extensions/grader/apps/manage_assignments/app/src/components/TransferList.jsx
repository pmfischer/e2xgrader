...
export default function TransferList() {
  ...
  const [left, setLeft] = React.useState([0, 1]);
  ...
  const availableTasksList = (items) => (
    <Paper sx={{ width: 200, height: 300, overflow: 'auto' }}>
      <Typography variant="h6" align="center">Selected Tasks</Typography>
      <Divider/>
      <FormControl>
  ...
  return (
    <Grid container spacing={2} justifyContent="center" alignItems="center">
      ...
      <Grid item>{availableTasksList(right)}</Grid>
    </Grid>
  );
}
